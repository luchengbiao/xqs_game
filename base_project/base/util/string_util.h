...
namespace nbase
{
	...
	BASE_EXPORT std::wstring StringPrintf(std::wstring format, ...);
	...
	BASE_EXPORT void StringSplit(std::string str, std::string pattern, std::vector<std::string>& vec);
	BASE_EXPORT void WstringSplit(std::wstring str, std::wstring pattern, std::vector<std::wstring>& vec);
}
