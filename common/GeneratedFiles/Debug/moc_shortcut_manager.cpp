...
QT_MOC_LITERAL(13, 236, 19) // "SingalChangeVersion"
    ...
    "SignalO2MPlayback\0SignalReadingSetting\0"
    "SingalChangeVersion"
};
...
void ShortCutManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: _t->SingalChangeVersion((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ShortCutManager::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ShortCutManager::SingalChangeVersion)) {
                *result = 9;
            }
        }
    }
...
// SIGNAL 9
void ShortCutManager::SingalChangeVersion(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
